...
var mySigningKey = []byte("TMOL4PYtkm-2UixvPXImIXpcYYD1ehJIabYHgpZcbp6yT4WseUC29xM-A4_zrNTL")

//var mySigningKey = []byte("secret")
//Tried with this value in my Auth0 Client Secret.
//Tried with secret -- as in the tutorial.
...
var jwtMiddleware = jwtmiddleware.New(jwtmiddleware.Options{
  ValidationKeyGetter: func(token *jwt.Token) (interface{}, error) {
    ...
    decoded := os.Getenv("AUTH0_CLIENT_SECRET")
